...
<div class="wrapper">
    ...
    <form method="POST" action="succ_create_staff.php" class="ht-600 w-50">
        ...
        <div class="form-group">
            ...
            <input type="text" name="staff_name" placeholder="Mlob Thaot's Hatsoff" id="staff_name" required class="form-control <?php echo (!empty($staff_name_err)) ? 'is-invalid' : ''; ?>"><br>
