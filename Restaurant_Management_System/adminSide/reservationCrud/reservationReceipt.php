...
require_once '../../adminSide/index.php';
...
if ($reservationInfo) {
    ...
    class PDF extends FPDF {
        function Header() {
            ...
            $logoText = "MLOB THAOT'S Restaurant";
            
            // Add a link-like style (you cannot create actual HTML links in PDF)
            $this->SetTextColor(0, 0, 0); // Set the text color to blue
            $this->Cell(0, 10, $logoText, 0, 1, 'C', false, 'http://localhost/rms_pcu/customerSide/home/home.php#home');
