...
<body>
    ...
    <form action="" method="post" >
        <div class="form-group">
            ...
            <input type="text" name="item_name" id="item_name" class="form-control"  placeholder="Soup" value="<?php echo htmlspecialchars($item_name); ?>" required>
        </div>
        <div class="form-group">
            <label for="item_type"  class="form-label">Item Type:</label>
            <input type="text" name="item_type" id="item_type" class="form-control"placeholder="Drinks.." value="<?php echo htmlspecialchars($item_type); ?>" required>
        </div>
